...
[![Views](https://komarev.com/ghpvc/?username=chrisszlycoen&style=for-the-badge&color=D4AF37&label=VIEWS)](https://github.com/chrisszlycoen)
...
> **I build secure systems that last — not scripts that break.**

```js
const chrisostom = {
    role:       "Security Engineer & Full-Stack Builder",
    building:   ["CAMINO — Student Transport Platform", "EduTrack — Student Management System"],
    focus:      ["Auth & RBAC", "Backend Architecture", "Real-time Systems", "Mobile (Flutter)"],
    languages:  ["Java", "Dart", "JavaScript", "TypeScript", "C", "Python"],
    principles: "Build assets. Design systems. Optimize for leverage."
};
```
...
[![My Skills](https://skillicons.dev/icons?i=java,js,ts,python,c,cpp,dart,php,bash,solidity&perline=10)](https://skillicons.dev)

[![My Skills](https://skillicons.dev/icons?i=react,flutter,remix,html,css,tailwind,bootstrap,redux,threejs&perline=9)](https://skillicons.dev)

[![My Skills](https://skillicons.dev/icons?i=nodejs,express,nestjs,fastapi,laravel,spring,hibernate,mongodb,mysql,postgres&perline=10)](https://skillicons.dev)

[![My Skills](https://skillicons.dev/icons?i=git,docker,firebase,vercel,postman,figma,blender,unity,cmake&perline=9)](https://skillicons.dev)
...
[![Ko-fi](https://img.shields.io/badge/☕_Buy_Me_a_Coffee-D4AF37?style=for-the-badge)](https://ko-fi.com/code888)
